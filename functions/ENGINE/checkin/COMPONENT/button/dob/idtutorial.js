module.exports.run = async (interaction) => {
  ...
  reply(interaction, `Hey, <@${interaction.channel.name}> seems like you are not following the ID verification instructions correctly. Please have another read of https://discord.com/channels/300051375914483715/496948681656893440/496985167160672267 and try again ^^`);
};
